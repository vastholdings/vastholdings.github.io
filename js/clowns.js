...
function drawWorm(ctx, t) {
  ...
  for (let i = 0; i < 20; i++) {
    ctx.fillRect(
      i * 10,
      -10 * Math.floor(2 * Math.sin((i * Math.PI) / 6 + t / 1000)),
      10,
      -10,
    )
  }
...
function drawExplosion(ctx, explosion) {
  ...
  for (let i = 0; i <= 16; i++) {
    ctx.fillStyle = 'brown'
    ctx.fillRect(
      explosion.r * Math.cos((Math.PI / 8) * i),
      -explosion.r * Math.sin((Math.PI / 8) * i),
      10,
      10,
    )
    ctx.fillStyle = 'red'
    ctx.fillRect(
      (explosion.r + 10) * Math.cos((Math.PI / 8) * i),
      -(explosion.r + 10) * Math.sin((Math.PI / 8) * i),
      10,
      10,
    )
    ctx.fillStyle = 'yellow'
    ctx.fillRect(
      (explosion.r + 20) * Math.cos((Math.PI / 8) * i),
      -(explosion.r + 20) * Math.sin((Math.PI / 8) * i),
      10,
      10,
    )
  }
